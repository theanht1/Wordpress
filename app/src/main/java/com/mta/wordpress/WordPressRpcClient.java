  ...
  //          LOGGER.error("Malformed URL: {}", xmlrpcUrl, e);
    ...
    private void verifyEndpoint() {
        try {
            ...
            Object[] results = (Object[]) sendRequest("wp.getPosts", Collections.<Object>singletonList(Collections.singletonMap("number", 1)));
            if (results == null) {
                loggedIn = false;
    ...
    private Object sendRequest(String methodName, List<Object> params) {
        try {
    ...
    public void retrievePosts() {
        ...
        if (posts == null) {
            posts = new HashMap<>();
            Object[] postsObject = (Object[]) sendRequest("wp.getPosts", Collections.<Object>singletonList(new Object[]{"post_id", "post_title", "terms"}));
    ...
    public Post addPost(Post p) {
       ...
       //     LOGGER.debug("Post exists, so updating rather than creating (post id is: {})", post.getPostId());
        ...
        if (edit) {
            ...
            returnObj = sendRequest("wp.newPost", Collections.<Object>singletonList(params));
    ...
    public void retrieveCategories() {
        ...
        Object o = sendRequest("wp.getTerms", Collections.<Object>singletonList("category"));
    ...
    public void uploadImage(String imageName, byte[] bytes) {
        checkLoggedIn();
        String mimeType;
     ...
     //   params.put("post_id", postId);
        ...
        Object o = sendRequest("wp.uploadFile", Collections.<Object>singletonList(params));
